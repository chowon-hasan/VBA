      ...
      <div className="container mx-auto">
        <div className="relative">
          <div className="flex flex-col z-20 items-center justify-center min-h-screen ">
            ...
            <div className="lg:w-[870px] text-2xl text-center my-10 lg:mx-16 bg-[#FFA616] text-white z-20 rounded-2xl p-3">
              <p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="mb-3">
                  ...
                  >
                    ...
                    <option value="Entre 2009 et 2015">
                      Entre 2009 et 2015
                    </option>
                    <option value="Supérieur à 2015">Supérieur à 2015</option>
                  </select>
                </div>
