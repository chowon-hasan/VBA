export default function Renault() {
  return (
    <div className="relative min-h-full">
      <img
        className="bg-cover bg-center bg-no-repeat absolute w-full h-full z-0 object-cover"
        src="https://cdn.discordapp.com/attachments/878674914268311625/1196813555580817458/WhatsApp_Image_2024-01-16_a_10.03.28_daccec62.jpg?ex=65b8fe7b&is=65a6897b&hm=5ec680f1d7e0c24c5509851b369d90816353112faf23f884a728d8963d64851f&"
      ></img>
      <div className="w-full z-20 items-center justify-center flex flex-col lg:p-24 z-20 relative">
        <div className="group rounded-xl shadow-2xl p-8 transition-color  border-8 bg-white/90 border-orangevba  md:w-3/5 lg:w-3/5 xl:w-5/12 text-center">
          ...
          <h2 className="text-4xl font-semibold pb-2">
            Calculateur Mercedes Class A
          </h2>
          <div className="text-center">
            <p className="mb-4">
              Module de commande (calculateur) pour boite automatique Mercedes
              Class A <br /> (2006 à 2011) Boite automatique CVT 722.8
            </p>
            ...
            <div className="flex justify-center space-x-4 pt-4">
              <a
                href="https://buy.stripe.com/7sI4jUd0cfVJ46s9AX"
